const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_LEVEL_ITEM, ITEM_KINGS_ROCK, SPECIES_POLITOED}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_LEVEL_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING}},
    ...
    [SPECIES_ONIX]       = {{EVO_LEVEL_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX}},
    ...
    [SPECIES_SEADRA]     = {{EVO_LEVEL_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 33, SPECIES_SEAKING}},
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_LEVEL_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR}},
    ...
    [SPECIES_PORYGON]    = {{EVO_LEVEL_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON2}},
    ...
    [SPECIES_PICHU]      = {{EVO_LEVEL, 15, SPECIES_PIKACHU}},
    [SPECIES_CLEFFA]     = {{EVO_LEVEL, 15, SPECIES_CLEFAIRY}},
    [SPECIES_IGGLYBUFF]  = {{EVO_LEVEL, 15, SPECIES_JIGGLYPUFF}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_LEVEL, 30, SPECIES_MILOTIC}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_LEVEL_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                            {EVO_LEVEL_ITEM, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS}},
