...
} static const sCursorOptions[] =
{
    ...
    // TODO: Should probably replace these but bc they are set at compile time its really hard to do that.
    // Tbh u know what the hm's are anyway via hm items so its probably reasonalbe to intuit these.
